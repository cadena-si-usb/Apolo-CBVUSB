...
# Libreria para funciones del sistema
...
templatesPath = join(dirname(__file__), "templates")
...
class emailManager():
    ...
    def sendMail(self, toMail, toSend, sslMode = False):
        try:
            ...
            # Mandar el correo
            server.sendmail(self.fromMail, toMail, toSend)
    ...
    def sendPRM(self, toMail, password):
        emailForm = "From: %s\nTo: %s\nSubject: %s\n%s\n\nContraseña: %s\n\n%s\n"          # Forma del correo
        subject = "Apolo - Recuperación de contraseña"                                     # Asunto
