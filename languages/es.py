...
'(something like "it-it")': '(algo como "algo-algo")',
'(version %s)': '(version %s)',
...
'Enable': 'Habilitar',
'Enter an integer between %(min)g and %(max)g': 'Ingrese un número entre %(min)g y %(max)g',
...
'Frames': 'Frames',
'Free Applications': 'Applicaciones libres',
...
'Repository: %s': 'Repositorio: %s',
'request': 'petición',
'Reset Password key': 'Resetear constraseña',
