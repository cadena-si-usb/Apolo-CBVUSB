...
def insertarServicio(horaCreacion, fechaCreacion, horaFinalizacion, fechaFinalizacion, descripcion, localizacion, tipo, borrador=True, aprueba=None):
    db.servicio.insert(
        Registra = 1,
        Aprueba = aprueba,
        Borrador = borrador,
...
def testCase():
    ...
    insertarServicio('12:35','2017/01/03','16:45','2017/01/03','Incendio edificio QYP.','USB, QYP.','IDE',True, True)
    ...
    insertarServicio('09:35','2017/02/25','12:30','2017/02/25','Incendio de vegetación en los alrededores del Pino Solitario.','Montaña USB, Pino Solitario.','IDV',True, True)
    ...
    insertarServicio('12:30','2017/02/10','15:40','2017/02/10','Rescate de búho perdido en salón de clases.','USB, ENE, piso 1, aula 110','RES2',False)
    ...
    insertarServicio('14:35','2017/01/17','20:45','2017/01/17','Liberación de gases tóxicos en entrada del edificio de QYP.','USB, QYP, Entrada sur.','MP',True)
