...
def testCase():
    ...
    insertarServicio('2017/01/03 12:35','2017/01/03 16:45','Incendio edificio QYP.','USB, QYP.','IDE')
    insertarServicio('2017/01/11 15:20','2017/01/11 17:55','Derrame de sustancias tóxicas en entrada de laboratorio de QYP.','USB, QYP, piso 2, lab 2A','MP')
    insertarServicio('2017/02/25 09:35','2017/02/25 12:30','Incendio de vegetación en los alrededores del Pino Solitario.','Montaña USB, Pino Solitario.','IDV')
    insertarServicio('2017/01/21 11:10','2017/01/22 14:55','Estudiante sufrió caida en escalera de auditorios.','USB, auditorios.','AME1')
    insertarServicio('2017/02/10 12:30','2017/02/10 15:40','Rescate de búho perdido en salón de clases.','USB, ENE, piso 1, aula 110','RES2')
    insertarServicio('2017/02/21 18:15','2017/02/22 19:45','Ocurrió incendio en árbol adyacente a lagunna de los patos.','USB, laguna de los patos.','IDV')
    insertarServicio('2017/01/17 14:35','2017/01/17 20:45','Liberación de gases tóxicos en entrada del edificio de QYP.','USB, QYP, Entrada sur.','MP')
    insertarServicio('2017/01/21 12:20','2017/01/22 16:50','Incendio de la vegetación cercana al tanque de agua de la USB.','USB, tanque de agua','Incendio Forestal')